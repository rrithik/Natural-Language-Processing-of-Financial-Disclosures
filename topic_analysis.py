...
stopwords = {
    "a","an","the","and","or","but","if","then","because","as","in","on","at","by",
    "for","of","to","from","with","about","over","under","between","through","during",
    "before","after","is","am","are","was","were","be","been","being","have","has",
    "had","do","does","did","will","would","shall","should","may","might","must",
    "can","could","he","she","it","they","them","we","us","you","i","me","my","your",
    "his","her","their","our","this","that","these","those","not","no","yes","just",
    "too","also","very"
}
...
topic_keywords = {
    "Financial Performance": {"revenue", "profit", "loss", "earnings", "income", "sales", "growth"},
    "Management/Leadership": {"board", "executive", "director", "ceo", "management", "leadership"},
    "Risk/Compliance": {"risk", "liability", "regulation", "uncertainty", "lawsuit", "exposure"},
    "Market/Operations": {"market", "product", "operations", "strategy", "customer", "investment"}
}
